...
namespace eosio { namespace chain { namespace wasm_constraints {
   constexpr unsigned maximum_linear_memory      = 125*1024*1024;//bytes
   constexpr unsigned maximum_mutable_globals    = 8192;        //bytes
   constexpr unsigned maximum_table_elements     = 8192;        //elements
   constexpr unsigned maximum_section_elements   = 8192;        //elements
   constexpr unsigned maximum_linear_memory_init = 512*1024;     //bytes
   constexpr unsigned maximum_func_local_bytes   = 65536;        //bytes
   constexpr unsigned maximum_call_depth         = 500;         //nested calls
   constexpr unsigned maximum_code_size          = 100*1024*1024;
